...
public class NffgReaderImplementation extends NamedEntityReaderImplementation implements NffgReader {
    ...
    public NffgReaderImplementation(NffgType nffg) throws NffgVerifierException{
	...
	@Override
	public NodeReader getNode(String nameOfNode) {
		...
		while (i.hasNext()) {
			...
			if (actual_node.getName().equals(nameOfNode))
				return actual_node;
		}		
		return null;	
	}
