...
}, comments = "wadl2java, http://wadl.java.net", date = "2017-01-31T10:10:19.759+01:00")
public class Localhost_NffgServiceRest {
    ...
    public static class Nffgs {
        ...
        public it.polito.dp2.NFFG.sol3.client1.Nffgs getAsNffgsXml() {
            ...
            return response.getEntity(it.polito.dp2.NFFG.sol3.client1.Nffgs.class);
        }
        ...
        public it.polito.dp2.NFFG.sol3.client1.Nffgs getAsNffgsJson() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
    ...
    public static class Policies {
        ...
        public it.polito.dp2.NFFG.sol3.client1.Policies getAsPoliciesXml() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
            resourceBuilder = resourceBuilder.accept("application/xml");
            ...
            return response.getEntity(it.polito.dp2.NFFG.sol3.client1.Policies.class);
        }
        ...
        public it.polito.dp2.NFFG.sol3.client1.Policies getAsPoliciesJson() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
            resourceBuilder = resourceBuilder.accept("application/json");
    ...
    public static class Verifications {
        ...
        public it.polito.dp2.NFFG.sol3.client1.Policies getAsPoliciesXml(String policyname) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (policyname == null) {
            }
            if (policyname!= null) {
        ...
        public it.polito.dp2.NFFG.sol3.client1.Policies getAsPoliciesJson(String policyname) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (policyname == null) {
            }
            if (policyname!= null) {
